---
title: "Preprocessing Allozithro"
format: html
editor: visual
---
...
Downloaded as csv from Bioproject

```         
cd ../Metadata
./clean_meta.sh meta_samples.csv
cd ../RawData
```
...
writeXStringSet(bact_seqs, "~/Documents/ODSi/ODSiData/Allozithro2017/FilteredData/blast_seqs.fasta")
...
Keeping only sequences classified by blast and present in at least 2 samples
...
qiime feature-table summarize \
  ...
  --m-sample-metadata-file ../Metadata/meta_samples_qiime.tsv
```

![](images/clipboard-3349140328.png)

![](images/clipboard-3736071805.png)

![](images/clipboard-2285115661.png)

![](images/clipboard-2163400282.png)
...
![](images/clipboard-1582509456.png)
...
Lost some features, have 410 left.

![](images/clipboard-2279159327.png){width="463"}
...
Choosing a taxonomy classifier based on V4 515F.
...
qiime taxa barplot \
  ...
  --m-metadata-file ../Metadata/meta_samples_qiime.tsv\
  --o-visualization taxa-bar-plots.qzv
```

![](images/clipboard-3446127984.png)

![](images/clipboard-1949670840.png)
