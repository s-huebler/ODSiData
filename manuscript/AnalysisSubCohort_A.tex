...
The taxon-level analysis grouped recipients according to the presence or absence of individual taxa and related these groups to transcriptional scores describing Treg differentiation, Treg suppression, and T-effector characteristics. 

\begin{itemize}

\item \taxClostridia and \taxBacteroidia: Taxa belonging to these classes were enriched in microbial clusters associated with higher Treg gene and Treg-suppression scores. 

\item \taxGammaproteobacteria: Taxa belonging to this class were enriched in microbial clusters associated with higher T-effector gene scores and lower Treg-supporting characteristics.

\item \taxStreptococcusSalivarius, \taxFaecalibacteriumPrausnitzii, \taxBlautiaWexlerae, and \taxBacteroidesOvatus: The authors specifically highlighted these species as members of a microbial cluster associated with more differentiated and suppressive Treg transcriptional phenotypes. Their presence was associated with the cluster-level Treg phenotype.

\item Antibiotic-associated taxonomic pattern: Taxa enriched in recipients who were not receiving broad-spectrum antibiotics overlapped with taxa assigned to the Treg-supporting clusters. 
