...
qiime feature-classifier classify-sklearn \
  ...
  --p-confidence 0.9 \
  --o-classification greengenes2_merged_taxonomy_full_length_90.qza
  
  qiime feature-classifier classify-sklearn \
  --i-classifier ../Greengenes2/2024.09.backbone.v4.nb.sklearn-1.4.2.qza\
  --i-reads merged-seqs.qza \
  --p-confidence 0.9 \
  --o-classification greengenes2_merged_taxonomy_v4_length_90.qza
```

```         
qiime taxa barplot \
  --i-table merged-table.qza \
  --i-taxonomy greengenes2_merged_taxonomy_full_length_90.qza \
  --m-metadata-file ../merged_metadata.tsv\
  --o-visualization merged-taxa-bar-plots_full_length_90.qzv
  
  qiime taxa barplot \
  --i-table merged-table.qza \
  --i-taxonomy greengenes2_merged_taxonomy_v4_length_90.qza \
  --m-metadata-file ../merged_metadata.tsv\
  --o-visualization merged-taxa-bar-plots_v4_length_90.qzv
```

Visually the full length looks better
...
```{r}
table_qza <- "~/Documents/ODSi/ODSiData/Merging/merged-table.qza"
taxonomy_qza  <- "~/Documents/ODSi/ODSiData/Merging/greengenes2_merged_taxonomy_full_length_90.qza"
repseqs_qza   <- "~/Documents/ODSi/ODSiData/Merging/merged-seqs.qza"      
tree_qza      <- "~/Documents/ODSi/ODSiData/Merging/greengenes2-merged-tree.qza"
```
